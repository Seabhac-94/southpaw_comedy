$(document).ready(function() {
  ...
  $('#cork').click(function() {
    $('.dublinResults, .limerickResults, .dublinResultsBox, .limerickResultsBox').slideUp('medium');
    $('.corkResults').slideDown('slow');
    $('.corkResultsBox').slideDown(1800);
  });

  $('#dublin').click(function() {
    $('.corkResults, .limerickResults, .corkResultsBox, .limerickResultsBox').slideUp('medium');
